-- ===================================================================
-- Migración: Actualizar SP de Plan Separé para Descuentos Flexibles
-- Fecha: 2026-02-14
-- Descripción: Actualiza sp_create_layaway para soportar discount_type
-- ===================================================================
...
BEGIN
  ...
  LOOP
    ...
    -- 🆕 NUEVO: Insertar con discount_type
...
'Crea un plan separé con soporte para descuentos por AMOUNT (valor fijo) o PERCENT (porcentaje).
...
DO $$
BEGIN
  RAISE NOTICE '✅ sp_create_layaway actualizado con soporte para discount_type';
  RAISE NOTICE '📝 Plan Separé ahora soporta descuentos por AMOUNT o PERCENT';
END $$;
